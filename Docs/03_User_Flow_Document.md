...
flowchart TD
    ...
    C --> D2[Clampbox card: Explore Clampbox]
    C --> E[Forkline card: Explore Forkline]
    C --> E2[Lattice card: Explore Lattice]
    D --> F[Route to /graphzy — Graphzy product page / app]
    D2 --> F2[Route to /clampbox — Clampbox detail page]
    E --> G[Route to /forkline — Forkline detail page]
    E2 --> G2[Route to /lattice — Lattice detail page]
