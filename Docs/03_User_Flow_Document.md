...
flowchart TD
    ...
    C --> E[Forkline card: Join Forkline Waitlist]
    C --> E2[Lattice card: Join Lattice Waitlist]
    D --> F[Route to /graphzy — Graphzy product page / app]
    E --> G[Route to /forkline — Forkline waitlist page]
    E2 --> G2[Route to /lattice — Lattice waitlist page]
