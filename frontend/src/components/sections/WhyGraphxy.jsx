...
const reasons = [
  {
    ...
    desc: "We believe code quality serves the user. We build clean, highly responsive UX that prioritizes utility over visual clutter."
  },
  {
      ...
      <Container className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
        <div>
          <SectionHeading 
            ...
            heading="Building tools with precision and architectural durability."
            description="We reject software clutter. Graphxy Labs creates digital interfaces focused on clean code, utility, and design restraint."
          />
        ...
        <div className="md:sticky md:top-24 mt-8 md:mt-0">
          <p data-reveal className="font-serif text-[20px] md:text-[24px] leading-[1.6] tracking-[-0.015em] text-[#525252] border-l-2 border-[#1B3A6B] pl-7 italic">
