  ...
  return (
    <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-10">
      <div className="flex justify-center items-center gap-4">
        <Tag variant="math" className="mb-6">PROTOTYPE MOCKUP</Tag>
      ...
      <p className="text-sm md:text-base text-[#525252] leading-[1.6] max-w-lg">
        Graphzy translates natural language queries into interactive STEM animations, equations, physics models, and chemical structures.
      </p>
    </div>
  );
}
