...
import VentureFlowHero from '../components/ventureflow/VentureFlowHero';
import VentureFlowWaitlist from '../components/ventureflow/VentureFlowWaitlist';
import VentureFlowFeatures from '../components/ventureflow/VentureFlowFeatures';
import { Card } from '../components/ui/Card';
import { Sparkles, TrendingUp, Check } from 'lucide-react';

export default function VentureFlow() {
  return (
    <PageShell>
      ...
      <div className="relative overflow-hidden bg-[#FAFAF8] py-16 md:py-24 border-b border-black/[0.04]">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-gradient-to-br from-[#1B3A6B]/5 to-transparent blur-3xl pointer-events-none rounded-full" />
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-gradient-to-tr from-[#0066CC]/5 to-transparent blur-3xl pointer-events-none rounded-full" />
            ...
            <div className="w-full max-w-2xl mt-16 animate-fade-in">
              <Card variant="surface" className="p-6 bg-white/80 border-[#1B3A6B]/15 shadow-sm backdrop-blur-sm overflow-hidden flex flex-col gap-4">
                <div className="flex justify-between items-center pb-3 border-b border-black/[0.06]">
                  ...
                  <span className="font-mono text-[10px] text-black/40">ventureflow.graphxy.com/dashboard/fundraising</span>
                </div>
            ...
            <div className="w-full mt-24">
              <div className="text-center mb-10 max-w-lg mx-auto">
                ...
                <p className="text-xs text-[#525252] leading-relaxed">
                  VentureFlow is built to replace disconnected spreadsheets, disorganized pitch deck links, and unmonitored investor outreach.
                </p>
              </div>
